...
#import "TranspoViewController.h"

@interface TranspoViewController ()

@end

@implementation TranspoViewController
...
- (void)viewDidLoad
{
    ...
    NSString *fullURL = @"http://sbtranspo.com/routes-and-fares/";
